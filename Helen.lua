...
if hash or DevHelen(msg) or VIP_DeV(msg) then    
return true  
else  
return false  
end  
...
if hash or DevHelen(msg) or DevBot(msg) or VIP_DeV(msg) then     
return true 
else 
return false 
end 
...
if hash or DevHelen(msg) or DevBot(msg) or BasicConstructor(msg) or VIP_DeV(msg) then        
return true    
else    
return false    
end 
...
if hash or DevHelen(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or VIP_DeV(msg) then        
return true    
else    
return false    
end 
...
if hash or DevHelen(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or VIP_DeV(msg) then        
return true    
else    
return false    
end 
...
if hash or DevHelen(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) or VIP_DeV(msg) then        
return true 
else 
return false 
end 
...
local Helen_Msg = database:get(bot_id.."Helen:Add:Filter:Rp2"..text..msg.chat_id_)   
if Helen_Msg then    
Reply_Status(msg,msg.sender_user_id_,"reply","♬︙"..Helen_Msg)  
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n♬︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Helen')..') '
...
local list = database:smembers(bot_id.."Helen:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."Helen:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Helen:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."Helen:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n♬︙قائمة المنع \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do  
local Helen_Msg = database:get(bot_id.."Helen:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..Helen_Msg.."}\n"    
end  
if #list == 0 then  
...
database:set(bot_id.."Helen:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."Helen:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."Helen:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
...
database:del(bot_id.."Helen:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."Helen:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."Helen:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."Helen:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end
...
database:del(bot_id.."Helen:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Helen:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."Helen:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
t = t.."♬︙"..x.."︙[@"..database:get(bot_id.."Helen:User:Name"..v.user_id_).."]\n"
end
end
send(msg.chat_id_,msg.id_,t)
end,nil)
...
send(msg.chat_id_, msg.id_,'♬︙عدد اعضاء المجموعه اقل من *~ {'..(database:get(bot_id..'Helen:Num:Add:Bot') or 0)..'* عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
...
if not DevHelen(msg) and not database:sismember(bot_id..'BaN:In:User',msg.sender_user_id_) and not database:get(bot_id..'Texting:In:Bv') then
...
if text and text:match("^- تغير الاشتراك ⌔ .$") and DevHelen(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '♬︙حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^- تغير رساله الاشتراك ⌔ .$") and DevHelen(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '♬︙حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ⌔ ." and DevHelen(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, "♬︙تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^- تعين قناة الاشتراك ⌔ .$") and DevHelen(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '♬︙حسنآ ارسل لي معرف القناة')
return false  
end
if text == "- تفعيل الاشتراك الاجباري ⌔ ." and DevHelen(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "- تعطيل الاشتراك الاجباري ⌔ ." and DevHelen(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, "♬︙تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "- الاشتراك الاجباري ⌔ ." and DevHelen(msg) then  
...
------------------------------------------------------------------------
if text then
local Helen_Msg = database:get(bot_id.."Helen:Add:Filter:Rp2"..text..result.chat_id_)   
if Helen_Msg then    
Reply_Status(result,result.sender_user_id_,"reply","♬︙"..Helen_Msg)  
DeleteMessage(result.chat_id_, {[0] = data.message_id_})     
return false
end
end
